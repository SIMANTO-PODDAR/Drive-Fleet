...
const Footer = () => {
    return (
        <div className="mt-10">
            <footer className="footer footer-horizontal footer-center bg-linear-to-r from-[#0D0D33]/60 to-[#0033FF]/60 text-[#0D0D33] rounded p-5">
                <Image src={Logo} alt="drivefleet-logo" height={100} />
                <div className="footer sm:footer-horizontal items-baseline grid grid-cols-2 sm:grid-cols-3 sm:justify-around gap-4">
                    <nav>
